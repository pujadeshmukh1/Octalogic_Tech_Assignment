...
const Administrator = () => {
  ...
  return (
    <div className="bg-[#E6FCED] min-h-screen flex flex-col justify-between">
      ...
      <div className="container px-4 lg:px-24 py-4 lg:py-8 ml-[-22%] md:ml-[-32%]">
        <p className="text-gray-500 text-center">Author: Glenn Fernandes</p>
        <p className="text-gray-500 text-center">Last Update: 22-08-2023</p>
      </div>
    </div>
  );
};
